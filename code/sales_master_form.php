...
{
?>
<option value="<?php echo $row1['Customer'];?>"><?php echo $row1['Customer'];?></option>
<?php
}
?>
    ...
    <tr>
      ...
      <td><input name="sd" type="date" id="sd"class="validate[required,custom[date]]" ></td>
    </tr>
    <tr>
      <td colspan="2"><input type="submit" name="Submit" value="Submit" class="btn btn-primary">
      <input type="reset" name="Reset" value="Reset" class="btn btn-banger">      </td>
      </tr>
  </table>
