...
<form name="formID" ID="formID" method="post" action="update_password.php">
  ...
  <table width="425" height="262" border="0">
    <tr>
      ...
      <td><input name="cp" type="password" id="cp"class="form-control validate[required]">
      </td>
    </tr>
    <tr>
      <td>New Password </td>
      <td><input name="pwd" type="password" id="pwd" class="form-control validate[required]"></td>
    </tr>
    <tr>
      <td>Confirm Password </td>
      <td><input name="pswd" type="password" id="pswd" class="form-control validate[required,confirm[pwd]]"></td>
    </tr>
    <tr>
