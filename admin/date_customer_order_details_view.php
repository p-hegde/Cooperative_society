                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                  <h1><span class="table-project-n">Customer Order   </span> Details</h1>
...
<b>From Date : <font color="#0000FF"><?php echo $date1; ?></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To Date : <font color="#0000FF"><?php echo $date2; ?></font>&nbsp;</b>
	...
	$sql="select * from customer_order_details cod,customer_details cd , products j where cod.customer_id=cd.customer_id and j.product_id=cod.product_id and cod.order_date between '$date1' and '$date2'";
    ...
    <tr>
      ...
      <td><a href="customer_order_details_confirm.php?id=<?php echo $row['order_id'];?>&current_stock=<?php echo $row['current_stock'];?>&qnt=<?php echo $row['quantity'];?>" onClick="return confirm('Are you sure to confirm?')" class="btn btn-primary">Confirm</a>&nbsp;</td> 
